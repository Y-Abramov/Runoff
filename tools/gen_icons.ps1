...
$Icons = @{
  ...
  # Взорвать водосбор: контур разорван на две половины + осколки.
  # Та же метафора, что у rf_explode, но узнаётся как водосбор по форме контура.
  'ws_explode' = {
    param($g,$S)
    Poly $g $S @(0.42,0.14, 0.24,0.22, 0.14,0.44, 0.24,0.70, 0.42,0.82) $BLUE_L 0.075 $false
    Poly $g $S @(0.58,0.14, 0.76,0.22, 0.86,0.44, 0.76,0.70, 0.58,0.82) $BLUE_L 0.075 $false
    Line $g $S 0.50 0.26 0.50 0.14 $GRAY 0.085
    Line $g $S 0.50 0.74 0.50 0.86 $GRAY 0.085
  }
